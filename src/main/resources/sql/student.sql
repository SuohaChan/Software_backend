...
BEGIN
    ...
    VALUES (NEW.id, -- 从 tb_student 表中获取 id
            '', -- 姓名暂时为空，可以在其他地方更新
            '', -- 性别暂时为空，可以在其他地方更新
            NEW.username, -- 使用身份证号作为 username
            '', -- 录取通知书编号暂时为空
            '', -- 学院暂时为空
            '', -- 人脸信息路径暂时为空
            0, -- 积分初始值为 0
...
-- 插入学生-学院-班级关联数据，使用默认学院和班级
INSERT INTO tb_student_class (student_id, college, clazz, counselor_id) VALUES
(1, '计算机科学与技术学院', '软件2201', 1),
(2, '计算机科学与技术学院', '软件2201', 1),
(3, '计算机科学与技术学院', '软件2201', 1),
(4, '计算机科学与技术学院', '软件2202', 1),
(5, '计算机科学与技术学院', '软件2202', 1),
(6, '计算机科学与技术学院', '软件2202', 1),
(7, '计算机科学与技术学院', '软件2202', 1),
(8, '机电工程学院', '机电2201', 1),
(9, '机电工程学院', '机电2201', 1),
(10, '机电工程学院', '机电2201', 1);