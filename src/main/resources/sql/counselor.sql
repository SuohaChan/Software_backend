...
-- 插入默认教师
INSERT INTO `tb_counselor` (`id`, `username`, `password`, `avatar`, `nickname`, `college`, `create_time`, `update_time`)
VALUES
    (1, 'default_teacher', 'e10adc3949ba59abbe56e057f20f883e', 'https://test-for-tree.oss-cn-beijing.aliyuncs.com/2060b522.png', '系统默认教师', '计算机科学与技术学院', NOW(), NOW()),
    (2, 'counselor_li', 'e10adc3949ba59abbe56e057f20f883e', '/avatar/li.jpg', '李辅导员', '计算机科学与技术学院', NOW(), NOW()),
    (3, 'counselor_wang', 'e10adc3949ba59abbe56e057f20f883e', '/avatar/wang.jpg', '王辅导员', '机电工程学院', NOW(), NOW());